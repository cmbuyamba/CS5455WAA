...
public class Calculator extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
  		...
  		String add1 = request.getParameter("add1") ==null?"":request.getParameter("add1").trim() ;
		String add2 = request.getParameter("add2") ==null?"":request.getParameter("add2").trim() ;
		String mult1 = request.getParameter("mult1") ==null?"":request.getParameter("mult1").trim() ;
		String mult2 = request.getParameter("mult2") ==null?"":request.getParameter("mult2").trim() ;
		...
		request.getRequestDispatcher("/WEB-INF/jsp/lab01/calculator.jsp").forward(request,response);
